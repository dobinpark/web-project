...
@Getter
@Entity
@Table(name = "notice_board")  // 이거 보고 테이블 생성
public class NoticeBoard extends BaseEntity {
    ...
    @Column(name = "notice_writer", length = 10, nullable = false)
    ...
    @Builder
    public NoticeBoard(Long id, String title, String content, String writer, Member userName) {
